	...
	return (
		<div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
				...
				{hasActiveSession ? (
					...
					>
						<div>
							...
							<div
								style={{
									fontSize: "calc(var(--vscode-font-size) * 1.6)",
									fontWeight: 600,
								}}
							>
						...
						>
							<div
								style={{
									...
									fontWeight: 700,
									color:
										data.currentSessionTokens > data.averageSessionTokens
											? "var(--vscode-charts-orange)"
											: "var(--vscode-charts-green)",
								}}
							>
								{calculatePercentage(
									data.currentSessionTokens,
									data.averageSessionTokens,
								)}
							</div>
							<div
								style={{
			...
			>
				...
				>
					Based on {data.sessionCount} session
